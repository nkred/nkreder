<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:28:"../Theme/admin/user\see.html";i:1536342672;s:42:"E:\php\loan\Theme\admin\Public\header.html";i:1536043477;s:42:"E:\php\loan\Theme\admin\Public\footer.html";i:1534405537;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<nav class="breadcrumb">
	...
	<span class="c-gray en">查看申请记录</span>
		...
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<?php foreach($data as $li): ?>
				<tr class="text-c">
					...
					<td class="f-14">
                        <?php if($li['status'] == 0): ?>
                        <a style="text-decoration:none" onClick="start('<?php echo $li['id']; ?>')" href="javascript:;" title="通过">
                            <i class="Hui-iconfont">&#xe6e1;</i>
                        </a>
                        <a style="text-decoration:none" onClick="stop('<?php echo $li['id']; ?>')" href="javascript:;" title="失败">
                            <i class="Hui-iconfont">&#xe6dd;</i>
                        </a>
                        <?php endif; ?>
                    </td>
...
<script type="text/javascript">
    /*失败*/
    function stop(id){
        layer.confirm('确认修改为失败吗？',function(index){
            //此处请求后台程序，下方是成功后的前台处理……
            $.ajax({
    ...
    /*成功*/
    function start(id) {
        layer.confirm('确认修改为成功吗？', function (index) {
            //此处请求后台程序，下方是成功后的前台处理……
            $.ajax({
