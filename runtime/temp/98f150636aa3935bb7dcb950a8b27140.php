<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:33:"../Theme/admin/count\index.html";i:1536368175;s:42:"E:\php\loan\Theme\admin\Public\header.html";i:1536043477;s:42:"E:\php\loan\Theme\admin\Public\footer.html";i:1534405537;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<?php foreach($data as $li): ?>
				<tr class="text-c">
					...
					<td class="f-14">
						<?php if($li['stauts'] == 0): ?>
						<a title="" onclick="public_edit('奖励金额','<?php echo url('see',array('id'=>$li['user'])); ?>','800','500')"  style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
						<?php endif; ?>
					</td>
				</tr>
			<?php endforeach; ?>
