<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:30:"../Theme/admin/agent\save.html";i:1536235256;s:42:"E:\php\loan\Theme\admin\Public\header.html";i:1536043477;s:42:"E:\php\loan\Theme\admin\Public\footer.html";i:1534405537;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<nav class="breadcrumb">
	...
	<span class="c-gray en">查看代理商</span>
	<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a>
</nav>
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			<a href="<?php echo url('see',['pid'=>$data['id']]); ?>" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe709;</i> 查看下线</a>
			<a href="<?php echo url('lists',['id'=>$data['id']]); ?>" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe709;</i> 查看明细</a>
		</span>
	</div>
		...
		<div id="tab-category" class="HuiTab">
			<div class="tabCon">
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<lable><?php echo $data['name']; ?></lable>
					</div>
					<div class="col-3">
					</div>
				</div>
				...
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">
						...
						身份证号码：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<lable><?php echo $data['card']; ?></lable>
					</div>
					<div class="col-3">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">
						...
						等级：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<lable><?php echo $data['level']; ?></lable>
					</div>
					<div class="col-3">
					</div>
				</div>
				<div class="row cl" <?php if($data['pid'] == 0): ?> hidden <?php endif; ?>>
					<label class="form-label col-xs-4 col-sm-3">
						<span class="c-red">*</span>
						上线：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<lable><?php echo $parent; ?></lable>
					</div>
					<div class="col-3">
					</div>
				</div>
			<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">
						...
						余额：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<lable><?php echo $data['money']; ?></lable>
					</div>
					<div class="col-3">
					</div>
				</div>
