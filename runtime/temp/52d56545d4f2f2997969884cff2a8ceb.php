<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:33:"../Theme/admin/student\index.html";i:1557564665;s:42:"E:\php\loan\Theme\admin\Public\header.html";i:1554530736;s:42:"E:\php\loan\Theme\admin\Public\footer.html";i:1534405538;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			<a class="btn btn-primary radius" href="<?php echo url('add'); ?>"><i class="Hui-iconfont">&#xe600;</i> 添加学生</a>
			<a class="btn btn-primary radius" href="<?php echo url('Export'); ?>">导出模板</a>
		</span>
		<div class="formControls col-xs-8 col-sm-9">
			<form action="<?php echo url('insertExcel'); ?>" enctype="multipart/form-data" method="post">
				<input class="input-text upload-url radius" type="file" name="excel" />
				<button class="btn btn-primary radius" type="submit"> &nbsp;&nbsp;导入&nbsp;&nbsp;</button>
			</form>
		</div>
	</div>
	<div class="mt-20">
		...
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<tr class="text-c">
				...
				<td><?php echo $li['card']; ?></td>
				<td><?php echo $li['sex']; ?></td>
				<td><?php echo $li['byxx']; ?></td>
				<td><?php echo $li['lqfs']; ?></td>
				<td><?php echo $li['nj']; ?></td>
				<td><?php echo $li['pid']; ?></td>
				<td><?php echo $li['m_id']; ?></td>
				<td><?php echo $li['xslb']; ?></td>
				<td><?php echo $li['xz']; ?></td>
				<td class="f-14">
					<a title="编辑" href="<?php echo url('save',array('id'=>$li['id'])); ?>"  style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
					<!--<a title="编辑" href="<?php echo url('save',array('id'=>$li['id'])); ?>"  style="text-decoration:none"><i class="Hui-iconfont">&#xe665;</i></a>-->
					<!--<a title="删除" href="javascript:;" onclick="public_del('<?php echo $li['id']; ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfot">&#xe6e2;</i></a>-->
				</td>
			</tr>
			<?php endforeach; ?>
			</tbody>
