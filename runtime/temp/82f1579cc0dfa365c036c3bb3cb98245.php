<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:34:"../Theme/admin/dormitory\save.html";i:1554556126;s:42:"F:\php\loan\Theme\admin\Public\header.html";i:1554530736;s:42:"F:\php\loan\Theme\admin\Public\footer.html";i:1534405538;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<nav class="breadcrumb">
	...
	<span class="c-gray en">修改宿舍</span>
			...
			<div class="tabCon">
				...
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">
						...
						人数：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="<?php echo $data['num']; ?>" placeholder="" name="num">
					</div>
					<div class="col-3">
					</div>
				</div>
