<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:29:"../Theme/admin/goods\index.html";i:1536336876;s:42:"E:\php\loan\Theme\admin\Public\header.html";i:1536043477;s:42:"E:\php\loan\Theme\admin\Public\footer.html";i:1534405537;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<nav class="breadcrumb">
	...
	<span class="c-gray en">添加产品</span>
	<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a>
</nav>
<div class="page-container">
	<form action="<?php echo url('add'); ?>"  method="post" class="form form-horizontal" id="form-category-add" enctype="multipart/form-data">
		<input value="<?php echo $goods_id; ?>" name="goods_id" hidden>
			...
			<div class="tabCon">
				...
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">
						...
						期限范围：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="" name="term">
					</div>
					<div class="col-3">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">
						...
						额度范围：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="" name="limit">
					</div>
					<div class="col-3">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">
						...
						日利率：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="" name="rate">
					</div>
					<div class="col-3">
					</div>
				</div>
				...
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">
						...
						奖金：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="" name="bonus">
					</div>
					<div class="col-3">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">
						...
						排行榜：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="" name="level">
					</div>
					<div class="col-3">
					</div>
				</div>
