<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:34:"../Theme/admin/students\index.html";i:1554542238;s:42:"F:\php\loan\Theme\admin\Public\header.html";i:1554530736;s:42:"F:\php\loan\Theme\admin\Public\footer.html";i:1534405538;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<?php foreach($data as $li): ?>
				<tr class="text-c">
					...
					<td><?php echo $li['p_tel']; ?></td>
					<td><?php echo $li['detil']; ?></td>
