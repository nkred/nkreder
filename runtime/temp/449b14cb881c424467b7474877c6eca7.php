<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:31:"../Theme/admin/goods\index.html";i:1536053249;s:42:"E:\php\loan\Theme\admin\Public\header.html";i:1536043477;s:42:"E:\php\loan\Theme\admin\Public\footer.html";i:1534405537;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
		<a class="btn btn-primary radius" href="<?php echo url('add',['goods_id'=>$goods_id]); ?>"><i class="Hui-iconfont">&#xe600;</i> 添加产品</a>
		</span>
		...
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<?php foreach($data as $li): ?>
				<tr class="text-c">
					...
					<td><?php echo $li['term']; ?>天</td>
					<td><?php echo $li['limit']; ?>元</td>
					<td><?php echo $li['rate']; ?>%</td>
					<td><?php echo $li['bonus']; ?>元</td>
					<td class="f-14"><a title="编辑" href="<?php echo url('save',array('id'=>$li['id'],'goods_id'=>$goods_id)); ?>"  style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
