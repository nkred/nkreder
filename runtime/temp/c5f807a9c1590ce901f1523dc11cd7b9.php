<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:29:"../Theme/admin/link\adds.html";i:1536134966;s:42:"E:\php\loan\Theme\admin\Public\header.html";i:1554530736;s:42:"E:\php\loan\Theme\admin\Public\footer.html";i:1534405538;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<nav class="breadcrumb">
	...
	<span class="c-gray en">添加链接</span>
		...
		<div id="tab-category" class="HuiTab">
			<div class="tabCon">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder=""name="controller">
					</div>
					<div class="col-3">
					</div>
				</div>
