<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:30:"../Theme/admin/link\index.html";i:1533394538;s:42:"F:\php\loan\Theme\admin\Public\header.html";i:1554530736;s:42:"F:\php\loan\Theme\admin\Public\footer.html";i:1534405538;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		...
		<a class="btn btn-primary radius" href="<?php echo url('adds'); ?>"><i class="Hui-iconfont">&#xe600;</i> 添加栏目</a>
		</span>
		...
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<?php foreach($data as $li): ?>
				<tr class="text-c">
					...
					<td class="text-l"><?php echo $li['html']; ?><?php echo $li['name']; ?></td>
					<td class="text-l"><?php echo $li['controller']; ?></td>
					<td class="text-l"><?php echo $li['action']; ?></td>
