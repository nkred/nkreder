<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:34:"../Theme/admin/register\index.html";i:1557805906;s:42:"E:\php\loan\Theme\admin\Public\header.html";i:1554530736;s:42:"E:\php\loan\Theme\admin\Public\footer.html";i:1534405538;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<?php foreach($data as $li): ?>
				<tr class="text-c">
					...
					<td class="f-14">
						<?php if($li['is_register']==0): ?>
							<a style="text-decoration:none" onClick="start('<?php echo $li['id']; ?>')" href="javascript:;" title="注册">
