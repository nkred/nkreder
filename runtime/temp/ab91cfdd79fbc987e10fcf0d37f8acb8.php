<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:30:"../Theme/admin/find\index.html";i:1557811185;s:42:"E:\php\loan\Theme\admin\Public\header.html";i:1554530736;s:42:"E:\php\loan\Theme\admin\Public\footer.html";i:1534405538;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<?php foreach($data as $li): ?>
				<tr class="text-c">
					...
					<td class="f-14"><a title="编辑" href="<?php echo url('save',['id'=>$li['id']]); ?>"  style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
