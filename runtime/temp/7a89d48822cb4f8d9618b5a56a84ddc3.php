<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:31:"../Theme/admin/count\index.html";i:1557811695;s:42:"E:\php\loan\Theme\admin\Public\header.html";i:1554530736;s:42:"E:\php\loan\Theme\admin\Public\footer.html";i:1534405538;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	<div class="mt-20">
		<div style="padding-bottom: 10px;">
			<label>总人数：<?php echo $data['z_num']; ?>  </label> <label>报到人数：<?php echo $data['b_num']; ?>  </label>
			<label>报到率：<?php echo $data['bdl']; ?>  </label>   <label>注册人数：<?php echo $data['c_num']; ?>  </label>
			<label>注册率：<?php echo $data['zcl']; ?>  </label>
		</div>
		...
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<?php foreach($list as $li): ?>
				<tr class="text-c">
					<td><?php echo $li['pid']; ?>-<?php echo $li['m_id']; ?></td>
					<td><?php echo $li['z_num']; ?></td>
					<td><?php echo $li['b_num']; ?></td>
					<td><?php echo $li['bdl']; ?></td>
					<td><?php echo $li['c_num']; ?></td>
					<td><?php echo $li['zcl']; ?></td>
				</tr>
			<?php endforeach; ?>
			</tbody>
		</table>
