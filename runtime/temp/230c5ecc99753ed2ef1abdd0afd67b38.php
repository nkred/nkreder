<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:35:"../Theme/admin/goodsclass\save.html";i:1536044884;s:42:"E:\php\loan\Theme\admin\Public\header.html";i:1536043477;s:42:"E:\php\loan\Theme\admin\Public\footer.html";i:1534405537;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						...
						<select class="select" id="sel_Sub" name="group_id">
							...
							<?php foreach($group as $li): if($li['id'] == $data['pid']): ?>
