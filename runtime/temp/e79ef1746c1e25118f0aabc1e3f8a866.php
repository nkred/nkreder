<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:31:"../Theme/admin/manger\save.html";i:1557493492;s:42:"E:\php\loan\Theme\admin\Public\header.html";i:1554530736;s:42:"E:\php\loan\Theme\admin\Public\footer.html";i:1534405538;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<article class="page-container">
	<form class="form form-horizontal" action=""  method="post" id="frm_manger">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
						...
						<select class="select" id="sel_Sub" name="group_id">
							<?php foreach($group as $li): if($li['id'] == $data['group_id']): ?>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-4 col-sm-4">
						...
						<select class="select" id="sel_Sub1" name="m_id">
							...
							<option value="<?php echo $li['id']; ?>" {if condition="$data.m_id==$li.id"} selected {if}><?php echo $li['name']; ?></option>
							<?php endforeach; ?>
						</select>
						</span>
			</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $data['name']; ?>" placeholder="请输入账号" id="name" name="name">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>登陆账号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $data['username']; ?>" placeholder="请输入账号" id="username" name="username">
			</div>
		</div>
		<div class="row cl">
