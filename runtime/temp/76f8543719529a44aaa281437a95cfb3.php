<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:31:"../Theme/admin/major\major.html";i:1557408638;s:42:"E:\php\loan\Theme\admin\Public\header.html";i:1554530736;s:42:"E:\php\loan\Theme\admin\Public\footer.html";i:1534405538;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<nav class="breadcrumb">
	...
	<span class="c-gray en">修改分类</span>
...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		...
		<a class="btn btn-primary radius" href="<?php echo url('addm',['id'=>$pid]); ?>"><i class="Hui-iconfont">&#xe600;</i> 添加专业</a>
		</span>
		...
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<?php foreach($data as $li): ?>
				<tr class="text-c">
					...
					<td class="text-l"><?php echo $li['name']; ?></td>
					<td><?php echo date("Y-m-d",$li['time']); ?></td>
					<td class="f-14"><a title="编辑" href="<?php echo url('savem',array('id'=>$li['id'])); ?>"  style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
