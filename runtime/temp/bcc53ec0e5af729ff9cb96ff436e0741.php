<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:37:"../Theme/admin/distribution\save.html";i:1557491306;s:42:"E:\php\loan\Theme\admin\Public\header.html";i:1554530736;s:42:"E:\php\loan\Theme\admin\Public\footer.html";i:1534405538;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
			...
			<div class="tabCon">
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" disabled="disabled" class="input-text" value="<?php echo $data['name']; ?>" placeholder="" name="">
					</div>
					<div class="col-3">
					</div>
				</div>
