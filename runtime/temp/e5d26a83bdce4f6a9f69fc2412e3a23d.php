<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:30:"../Theme/admin/group\save.html";i:1531710468;s:42:"F:\php\loan\Theme\admin\Public\header.html";i:1554530736;s:42:"F:\php\loan\Theme\admin\Public\footer.html";i:1534405538;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
			...
			<div class="tabCon">
				...
				<div class="row cl">
					...
					<div class="col-sm-9 col-xs-8">
						...
						if($v['checked'] == true){
						echo '<li><div class="checkbox">'.$v['html'].'<label><input type="checkbox" name="link[][id]" style="margin-top:3px;" value="'.$v['id'].'" onclick="check(this);" controller="'.$v['controller'].'" checked="checked" /> <i></i> '.$v['name'].'</label></div>';
							}else{
