<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:31:"../Theme/admin/major\index.html";i:1557408458;s:42:"E:\php\loan\Theme\admin\Public\header.html";i:1554530736;s:42:"E:\php\loan\Theme\admin\Public\footer.html";i:1534405538;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		...
		<a class="btn btn-primary radius" href="<?php echo url('adds'); ?>"><i class="Hui-iconfont">&#xe600;</i> 添加院系</a>
		</span>
			...
			<?php foreach($data as $li): ?>
				<tr class="text-c">
					...
					<td class="f-14"><a title="编辑" href="<?php echo url('save',array('id'=>$li['id'])); ?>"  style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
						<a title="查看专业" href="<?php echo url('major',array('id'=>$li['id'])); ?>"  style="text-decoration:none"><i class="Hui-iconfont">&#xe665;</i></a>
