<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:31:"../Theme/admin/major\savem.html";i:1557409378;s:42:"E:\php\loan\Theme\admin\Public\header.html";i:1554530736;s:42:"E:\php\loan\Theme\admin\Public\footer.html";i:1534405538;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<nav class="breadcrumb">
	<a class="btn btn-primary radius" style="line-height:1.6em;margin-top:-5px" href="<?php echo url('major',['id' =>$class['id']]); ?>">返回</a>
	<span class="c-gray en">修改链接</span>
	<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a>
</nav>
<div class="page-container">
	<form action="<?php echo url('savem'); ?>"  method="post" class="form form-horizontal" id="form-category-add">
			...
			<div class="tabCon">
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" disabled="disabled" class="input-text" value="<?php echo $class['name']; ?>" placeholder="">
						<input type="text" hidden class="input-text" value="<?php echo $class['id']; ?>" placeholder="" name="pid">
					</div>
					<div class="col-3">
					</div>
				</div>
