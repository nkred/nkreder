<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:30:"../Theme/admin/major\addm.html";i:1557409415;s:42:"E:\php\loan\Theme\admin\Public\header.html";i:1554530736;s:42:"E:\php\loan\Theme\admin\Public\footer.html";i:1534405538;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<nav class="breadcrumb">
	<a class="btn btn-primary radius" style="line-height:1.6em;margin-top:-5px" href="<?php echo url('major',['id' =>$data['id']]); ?>">返回</a>
	<span class="c-gray en">添加专业</span>
	<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a>
</nav>
<div class="page-container">
	<form action="<?php echo url('addm'); ?>"  method="post" class="form form-horizontal" id="form-category-add">
			...
			<div class="tabCon">
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" disabled="disabled" class="input-text" value="<?php echo $data['name']; ?>" placeholder="">
						<input type="text" hidden class="input-text" value="<?php echo $data['id']; ?>" placeholder="" name="pid">
					</div>
					<div class="col-3">
					</div>
				</div>
